...
namespace testWin {
	...
	/// </summary>
//	public ref class MyForm // JPP3
	public ref class MyForm : public System::Windows::Forms::Form // JPP3
	{
	public:
		MyForm(void)
		{
...
#pragma region Windows Form Designer generated code
			 ...
			 void InitializeComponent(void)
			 {
				 ...
				 this->btn_first->Click += gcnew System::EventHandler(this, &MyForm::btn_first_Click); // JPP4
								 // 
				 // btn_previous
				 // 
				 ...
				 // fld_source
				 // 
				 this->fld_source->RootFolder = System::Environment::SpecialFolder::MyComputer; // JPP Extra 
				 // 
				 // fld_destination
				 // 
				 this->fld_destination->RootFolder = System::Environment::SpecialFolder::MyComputer; // JPP Extra 
				 // MyForm
				 // 
...
//	private: System::Void btn_source_Click // JPP5
	{
		int i;

		this->svcFichier = gcnew NS_services::CLserviceFichier(); // JPP6
	...
	{
		if (pctBx->Image != nullptr)   // JPP7
		{                              // JPP7
			delete pctBx->Image;       // JPP7
			pctBx->Image = nullptr;    // JPP7
		...
		else if (this->rdb_effacer->Checked == true) // JPP8
		{                                            // JPP8 
			this->svcFichier->effacer(this->listeDeFichier); // JPP8
			this->txt_rslt->Text = "Les fichiers ont été supprimés depuis l'emplacement : " + this->txt_source->Text; // JPP8
		}                                           // JPP8
